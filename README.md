...
.
The core of the system is a custom-designed, single-cycle RISC-V RV32I processor written in VHDL from scratch
. The processor serves as the brain for an interactive bare-metal video game: a "Labyrinth" where the user must guide a ball from a starting point to a finish line, carefully avoiding walls and holes
.
The system highlights a strong Hardware/Software Co-Design approach:
Hardware: The physical inclination of the board is constantly monitored using the onboard ADXL362 3-axis accelerometer, managed by a custom SPI controller
