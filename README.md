...
The core of the system is a custom-designed, single-cycle RISC-V RV32I processor written in VHDL. The processor serves as the brain for an interactive video game: a "Labyrinth" where the user must guide a ball from a starting point to a finish line, carefully avoiding walls and holes. 
